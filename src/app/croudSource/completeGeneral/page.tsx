...
export default function MedicalDataForm() {
  ...
  return (
    <div className="flex justify-center items-center flex-col">
      <label
        className="text-green-700 underline font-bold  text-2xl"
        htmlFor=""
      >
        Complete General Medical From
      </label>
      <form
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleInputChange({
                    target: { name: "smoking", type: "checkbox", checked },
                  })
                }
              />
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handleInputChange({
                    target: { name: "alcohol", type: "checkbox", checked },
                  })
                }
              />
          ...
          <div className="space-y-4">
            <div>
              ...
              <Slider
                ...
                onValueChange={(value) =>
                  handleSliderChange("painLevel", value)
                }
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="sleepQuality">
                Sleep Quality (hours of deep sleep)
              </Label>
              <Input
                id="sleepQuality"
                name="sleepQuality"
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                value={formData.mood}
                onValueChange={(value) =>
                  handleInputChange({ target: { name: "mood", value } })
                }
              >
                <SelectTrigger>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Textarea
                id="genomicData"
                name="genomicData"
                placeholder="Enter any relevant genomic data"
